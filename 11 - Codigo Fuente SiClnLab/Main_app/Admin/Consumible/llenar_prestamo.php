	...
	<div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<br>
					<a href="/SiClnLab/Main_app/Admin/Consumible/prestamo_consumible.php" > <button class="btn btn-success" type="button" id="eliminar" value="">Finalizar prestamo</button> </a>
