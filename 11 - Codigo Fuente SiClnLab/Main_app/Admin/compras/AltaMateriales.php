...
if(@$_POST['txtfld_nombre1_material']){
$id_unid=$mysqli->query("SELECT id_unids FROM unids WHERE nombr='".$_POST['opcion_unidades']."'");	
	$id=$id_unid->fetch_assoc();
$sql="INSERT INTO mater ( nombr,capac, canti, marca, fk_unids) VALUES ( '".$_POST['txtfld_nombre1_material']."',".$_POST['txtfld_capacidad_material'].", ".$_POST['txtfld_cantidad_material'].", '".$_POST['txtfld_marca_material']."',".$id['id_unids'].")";
